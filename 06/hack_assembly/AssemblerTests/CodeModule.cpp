...
namespace assembler_tests
{
    BOOST_FIXTURE_TEST_SUITE(ModulesTests, Configuration)
        ...
        BOOST_AUTO_TEST_SUITE(BaseCodeModuleTest)
            ...
            {
                auto code_module = make_unique<Decoder>();
                ...
                BOOST_TEST(code_module->decode(jump("JGT"))== JGT.to_string());
                BOOST_TEST(code_module->decode(jump("JEQ"))== JEQ.to_string());
                BOOST_TEST(code_module->decode(jump("JGE"))== JGE.to_string());
                BOOST_TEST(code_module->decode(jump("JLT"))== JLT.to_string());
                BOOST_TEST(code_module->decode(jump("JNE"))== JNE.to_string());
                BOOST_TEST(code_module->decode(jump("JLE"))== JLE.to_string());
                BOOST_TEST(code_module->decode(jump("JMP"))== JMP.to_string());
            }
            ...
            BOOST_AUTO_TEST_CASE(CorrectDestMnemonics)
            {
                ...
                BOOST_TEST(code_module->decode(dest("M"))== b_M.to_string());
                BOOST_TEST(code_module->decode(dest("D"))== b_D.to_string());
                BOOST_TEST(code_module->decode(dest("MD")) == b_MD.to_string());
                BOOST_TEST(code_module->decode(dest("A"))== b_A.to_string());
                BOOST_TEST(code_module->decode(dest("AM")) == b_AM.to_string());
                BOOST_TEST(code_module->decode(dest("AD")) == b_AD.to_string());
                BOOST_TEST(code_module->decode(dest("AMD")) == b_AMD.to_string());
            }
            ...
            BOOST_AUTO_TEST_CASE(CorrectCompMnemonics)
            {
                ...
                BOOST_TEST(code_module->decode(comp("0"))== zero.to_string());
                BOOST_TEST(code_module->decode(comp("1"))== one.to_string());
                BOOST_TEST(code_module->decode(comp("-1"))== nOne.to_string());
                BOOST_TEST(code_module->decode(comp("D"))== D.to_string());
                BOOST_TEST(code_module->decode(comp("A"))== A.to_string());
                BOOST_TEST(code_module->decode(comp("!D"))== nD.to_string());
                BOOST_TEST(code_module->decode(comp("!A"))== nA.to_string());
                BOOST_TEST(code_module->decode(comp("-D"))== negD.to_string());
                BOOST_TEST(code_module->decode(comp("-A"))== negA.to_string());
                BOOST_TEST(code_module->decode(comp("D+1"))== Dp1.to_string());
                BOOST_TEST(code_module->decode(comp("A+1"))== Ap1.to_string());
                BOOST_TEST(code_module->decode(comp("D-1"))== Dm1.to_string());
                BOOST_TEST(code_module->decode(comp("A-1"))== Am1.to_string());
                BOOST_TEST(code_module->decode(comp("D+A"))== DpA.to_string());
                BOOST_TEST(code_module->decode(comp("D-A"))== DmA.to_string());
                BOOST_TEST(code_module->decode(comp("A-D"))== AmD.to_string());
                BOOST_TEST(code_module->decode(comp("D&A"))== DandA.to_string());
                BOOST_TEST(code_module->decode(comp("D|A"))== DorA.to_string());

                BOOST_TEST(code_module->decode(comp("M"))== M.to_string());
                BOOST_TEST(code_module->decode(comp("!M"))== nM.to_string());
                BOOST_TEST(code_module->decode(comp("-M"))== negM.to_string());
                BOOST_TEST(code_module->decode(comp("M+1"))== Mp1.to_string());
                BOOST_TEST(code_module->decode(comp("M-1"))== Mm1.to_string());
                BOOST_TEST(code_module->decode(comp("D+M"))== DpM.to_string());
                BOOST_TEST(code_module->decode(comp("D-M"))== DmM.to_string());
                BOOST_TEST(code_module->decode(comp("M-D"))== MmD.to_string());
                BOOST_TEST(code_module->decode(comp("D&M"))== DandM.to_string());
                BOOST_TEST(code_module->decode(comp("D|M"))== DorM.to_string());
            }
